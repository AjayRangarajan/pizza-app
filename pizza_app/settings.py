...
SECRET_KEY = 'django-insecure-j*u@x$h9j=tv)qd7b0c+jfmj)17iwtuenl=v32tu&bpb&3q(%*'
...
# mongodb+srv://ajayrangarajan:<password>@cluster0.iyd1p.mongodb.net/myFirstDatabase?retryWrites=true&w=majority
